...
export const sfx = {
  ...
  build: () => {
    ...
    tone(660, 0.1, "square", 0.04, 0.08);
  },
  upgrade: () => {
    [523, 659, 784].forEach((f, i) => tone(f, 0.12, "triangle", 0.06, i * 0.08));
  },
  complete: () => {
    [523, 659, 784, 1046].forEach((f, i) => tone(f, 0.18, "sine", 0.07, i * 0.09));
  },
  gift: () => {
    tone(880, 0.1, "sine", 0.06);
    tone(1175, 0.14, "sine", 0.05, 0.1);
  },
