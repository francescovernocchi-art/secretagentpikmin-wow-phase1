...
export const BIOMES: Record<BiomeKey, BiomeConfig> = {
  foresta: {
    ...
    emoji: "🌿",
    image: foresta,
    tagline: "Lattine, ghiande e foglie giganti",
    bonuses: ["Crescita Pikmin", "Raccolta Risorse", "Rigenerazione"],
    accent: "#7cd99a",
  },
  roccioso: {
    key: "roccioso",
    ...
    emoji: "🪨",
    image: roccioso,
    tagline: "Lattine e cristalli tra le rocce",
    bonuses: ["Difesa", "Resistenza", "Estrazione"],
    accent: "#a8a29e",
  },
  litorale: {
    key: "litorale",
    ...
    emoji: "🌊",
    image: litorale,
    tagline: "Bottiglie-faro e capanne di conchiglia",
    bonuses: ["Pesca", "Nettare Marino", "Velocità"],
    accent: "#7ec0e8",
  },
  montanaro: {
    key: "montanaro",
    ...
    emoji: "⛰️",
    image: montanaro,
    tagline: "Tazza fumante e thermos sulla neve",
    bonuses: ["Resistenza Freddo", "Vista Lontana", "Energia"],
    accent: "#cbd5e1",
  },
  vulcanico: {
    key: "vulcanico",
    ...
    emoji: "🔥",
    image: vulcanico,
    tagline: "Accendini e fiammiferi nella lava",
    bonuses: ["Produzione Calore", "Attacco", "Velocità Costruzione"],
    accent: "#fb923c",
  },
  industriale: {
    key: "industriale",
    ...
    emoji: "⚙️",
    image: industriale,
    tagline: "Barattoli di vernice e batterie",
    bonuses: ["Automazione", "Produzione Avanzata", "Droni"],
    accent: "#c084fc",
  },
  spaziale: {
    key: "spaziale",
    ...
    emoji: "🚀",
    image: spaziale,
    tagline: "Bombolette razzo e cupole su crateri",
    bonuses: ["Esplorazione", "Scoperte Rare", "Eventi Speciali"],
    accent: "#67e8f9",
  },
  desertico: {
    key: "desertico",
    ...
    emoji: "🌵",
    image: desertico,
    tagline: "Cactus, vasi terracotta e dune",
    bonuses: ["Resistenza Calore", "Raccolta Rara", "Viaggio Veloce"],
    accent: "#fbbf24",
  },
};
