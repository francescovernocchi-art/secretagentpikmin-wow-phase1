export function Radar({ size = 220 }: { size?: number }) {
  return (
    <div className="relative mx-auto rounded-full" style={{ width: size, height: size }}>
      ...
      <span
        className="absolute left-[22%] top-[60%] h-2 w-2 rounded-full bg-primary/80 shadow-[0_0_10px_var(--color-primary)] animate-radar-ping"
        style={{ animationDelay: "0.6s" }}
      />
      <span
        className="absolute left-[70%] top-[68%] h-2 w-2 rounded-full bg-primary/70 shadow-[0_0_10px_var(--color-primary)] animate-radar-ping"
