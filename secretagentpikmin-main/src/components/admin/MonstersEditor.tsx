      ...
      {list.map((e) => (
        <div key={e.id} className="panel-strong p-3 flex gap-3 items-start">
          ...
          <div className="flex-1 grid grid-cols-2 gap-2 text-xs">
            <label>
              Chiave
              <input className="w-full input" value={e.key} disabled />
            </label>
            <label>
              Nome
              <input
            ...
            <label>
              ...
              <input
                className="w-full input"
                value={e.emoji}
                onChange={(ev) => patch(e.id, { emoji: ev.target.value })}
              />
            </label>
            <label>
              Pericolo
              <input
                ...
                max={10}
                className="w-full input"
                value={e.danger_level}
                onChange={(ev) => patch(e.id, { danger_level: Number(ev.target.value) })}
              />
            </label>
            <label>
              HP
              <input
                ...
                className="w-full input"
                value={e.hp}
                onChange={(ev) => patch(e.id, { hp: Number(ev.target.value) })}
              />
            </label>
            <label>
              Danno
              <input
                ...
                className="w-full input"
                value={e.damage}
                onChange={(ev) => patch(e.id, { damage: Number(ev.target.value) })}
              />
            </label>
            <label className="col-span-2">
              ...
              <input
                className="w-full input"
                value={e.habitat ?? ""}
                onChange={(ev) => patch(e.id, { habitat: ev.target.value })}
              />
            </label>
            <label className="col-span-2">
              Descrizione
            ...
            <button
              onClick={() => remove(e)}
              className="panel p-2 flex items-center justify-center gap-1 text-xs text-destructive"
            >
