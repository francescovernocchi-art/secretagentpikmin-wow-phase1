  ...
  return (
    ...
    >
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        <Link to="/inventario" className="btn-neon py-2 text-xs text-center">
          Inventario
        </Link>
        <Link to="/spedizioni" className="panel-strong py-2 text-xs text-center">
          Spedizioni
        </Link>
      </div>
    </VillagePanelSheet>
