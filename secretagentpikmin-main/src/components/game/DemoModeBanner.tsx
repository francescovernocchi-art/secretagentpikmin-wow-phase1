...
export function DemoModeBanner() {
  ...
  return (
    <>
      <div className="fixed bottom-[5.5rem] left-3 right-3 z-30 max-w-lg mx-auto pointer-events-none hidden sm:block">
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                <Link
                  to="/radar"
                  className="btn-neon px-2 py-1 text-[9px] uppercase tracking-wider"
                >
                  Scanner
                </Link>
                <Link
                ...
                <Link to="/chat" className="btn-neon px-2 py-1 text-[9px] uppercase tracking-wider">
                  Chat
                </Link>
              </div>
            </div>
      ...
      <div className="fixed bottom-[5.15rem] right-2 z-30 sm:hidden pointer-events-auto">
        <div className="market-card px-2 py-1.5 border-primary/40 shadow-lg flex items-center gap-1.5">
          <Sparkles className="h-3.5 w-3.5 text-primary shrink-0" />
          <span className="text-[9px] uppercase tracking-widest text-primary">Demo</span>
          <button
            type="button"
            onClick={() => {
              if (isDemoModeActive()) {
            ...
            className="panel p-1 min-h-8 min-w-8 shrink-0"
            aria-label="Chiudi demo"
          >
            <X className="h-3.5 w-3.5" />
          </button>
